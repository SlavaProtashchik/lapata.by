...
class WooCommerce_Widget_DropdownCart extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<a href="" class="dropdowncarttrigger" title="open">';
		include("cart.svg"); //вставляем svg картинку
	//	echo '</span>';
		$not_null=	 "";
...
// REGISTER THE WIDGET
	...
	// Load the CSS
//lex	add_action('wp_print_styles', 'dropdowncart_stylesheet',0);
	// Load the jScript
...
/* lex
	function dropdowncart_stylesheet() {
		...
		// Respects SSL, Style.css is relative to the current file
		   ...
		   $theme_stylesheet_file		 = get_template_directory() . '/includes/widgets/woocommerce-drop-down-cart-widget/widget-flyout-cart-style.css';
		   $theme_stylesheet_url		 = get_template_directory_uri() . '/includes/widgets/woocommerce-drop-down-cart-widget/widget-flyout-cart-style.css'; 
...
*/
	...
	function dropdowncart_scripts() {
		...
		// Respects SSL, Style.css is relative to the current file
	       $dropdowncart_jscript_url  = get_template_directory_uri(). '/includes/widgets/woocommerce-drop-down-cart-widget/widget-flyout-cart-script.js';
	       $dropdowncart_jscript_file = get_template_directory()  . '/includes/widgets/woocommerce-drop-down-cart-widget/widget-flyout-cart-script.js';
